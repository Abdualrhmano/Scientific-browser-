...
export const useBrowserStore = create<BrowserState>()(
  devtools((set) => {
    ...
    return {
      tabs: [
        { id: makeId('tab'), title: 'Quantum Computing Dynamics', url: '', type: 'research', active: true, createdAt: Date.now() },
        { id: makeId('tab'), title: 'MIT Physics Lecture Video', url: 'https://www.w3schools.com/html/mov_bbb.mp4', type: 'video', active: false, createdAt: Date.now() }
      ],
      bookmarks: [],
      deepSearchOpen: true,
      libraryOpen: true,
